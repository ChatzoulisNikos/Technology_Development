...
public class SimpleClientApp {
	...
	//this code represents a simple client application that utilized the functionality provided by the appController class to perform various queries and operations on a data set  related to climate-related disasters.
