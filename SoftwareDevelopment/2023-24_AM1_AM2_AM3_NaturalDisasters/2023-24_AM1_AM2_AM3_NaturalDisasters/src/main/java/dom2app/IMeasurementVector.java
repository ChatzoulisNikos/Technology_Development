...
// the IMeasurementVector interface defines methods for retrieving data related to a measurement vector, which represents the data for a country , disaster type combination . 
}